...
export default function Home() {
  ...
  const handleSearch = async (searchParams: {
    ...
    setLoading(true)
    setCurrentKeyword(searchParams.keyword) // Store the keyword for use in results
  ...
  // Generate multiple domain combinations
  const generateDomainCombinations = (searchParams: {
    ...
    // Use only the selected city instead of multiple cities
